 ...
 * 
 * Describe: The business logic bootstrap script file for the site message page (../../../../../../www/site.message.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.11.23 18:08 ( Tony ).
 * 
 * Last Update: 2014.11.23 19:19 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/site.message.logic.min');
		
		/*plusLogic = require('logic/site.message.logic.plus');*/
