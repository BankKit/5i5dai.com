 ...
 * 
 * Describe: The business logic bootstrap script file for the real name authentication page (../../../../../../www/real.name.authentication.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2013.12.18 18:28 ( Tony ).
 * 
 * Last Update: 2014.01.12 22:10 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/rna.logic.min');
		
		// plusLogic = require('logic/rna.logic.plus');
