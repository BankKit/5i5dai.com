 ...
 * 
 * Describe: The business logic bootstrap script file for the investment progress page (../../../../../../www/invest.progress.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2013.12.30 19:38 ( Tony ).
 * 
 * Last Update: 2014.01.12 22:04 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/invest.progress.logic.min');

		// plusLogic = require('logic/invest.progress.logic.plus');
