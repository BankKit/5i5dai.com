 ...
 * 
 * Describe: The business logic bootstrap script file for the " find password " page (../../../../../../www/find.password.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.01.14 17:20 ( Tony ).
 * 
 * Last Update: 2014.01.14 19:03 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/find.password.logic.min');
		
		/*plusLogic = require('logic/find.password.logic.plus');*/
