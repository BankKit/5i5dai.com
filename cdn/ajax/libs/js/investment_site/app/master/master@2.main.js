 ...
 * 
 * Describe: The business logic bootstrap script file for the second master page (../../../../../../www/master@2.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2013.12.09 21:45 ( Tony ).
 * 
 * Last Update: 2013.12.09 22:42 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		var modernizr, SJ, master2BasicLogic, plusLogic, testScript, modifyTitle;
		
		modernizr = require('modernizr');
		
		SJ = require('jquery');
		
		master2BasicLogic = require('logic/master@2.logic');

		plusLogic = require('logic/master@2.logic.plus');
