 ...
 * 
 * Describe: The business logic bootstrap script file for the email authentication page (../../../../../../www/email.authentication.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2013.12.19 14:14 ( Tony ).
 * 
 * Last Update: 2014.01.12 22:18 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/ea@1.logic.min');
		
		// plusLogic = require('logic/ea@1.logic.plus');
