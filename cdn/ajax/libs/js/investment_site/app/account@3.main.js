 ...
 * 
 * Describe: The business logic bootstrap script file for the transaction detail page (../../../../../../www/account@3.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.01.09 17:41 ( Tony ).
 * 
 * Last Update: 2014.01.12 22:17 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/account@3.logic.min');
		
		// plusLogic = require('logic/account@3.logic.plus');
