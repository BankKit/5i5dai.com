 ...
 * 
 * Describe: The business logic bootstrap script file for the " my investment list details " page (../../../../../../www/account@7.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.01.13 13:43 ( Tony ).
 * 
 * Last Update: 2014.01.13 16:23 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/account@7.logic.min');
		
		// plusLogic = require('logic/account@5.logic.plus');
