 ...
 * 
 * Describe: The business logic bootstrap script file for the password reset result page (../../../../../../www/reset.password.result.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.01.14 16:39 ( Tony ).
 * 
 * Last Update: 2014.01.14 16:57 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/reset.password.result.logic.min');
		
		/*plusLogic = require('logic/account@1.logic.plus');*/
