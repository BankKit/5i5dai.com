 ...
 * 
 * Describe: The business logic bootstrap script file for the password reset page (../../../../../../www/reset.password.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.01.14 14:56 ( Tony ).
 * 
 * Last Update: 2014.01.14 14:57 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/reset.password.logic.min');
		
		/*plusLogic = require('logic/reset.password.logic.plus');*/
