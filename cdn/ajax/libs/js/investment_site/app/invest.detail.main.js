 ...
 * 
 * Describe: The business logic bootstrap script file for the investment details page (../../../../../../www/invest.detail.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.01.05 19:53 ( Tony ).
 * 
 * Last Update: 2014.01.06 17:49 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/invest.detail.logic.min');
		
		// plusLogic = require('logic/invest.detail.logic.plus');
