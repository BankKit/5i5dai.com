 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2013.12.19 17:51 ( Tony ).
 * 
 * Last Update: 2013.12.19 18:27 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
			...
			return {
				...
				init: function () {
					...
					function excute(o) {
						...
						var i = +SJ('.span_2').children('span').text();
						...
						function countDown() {
							...
							if (i === 0) {
								...
								SJ('.span_2').children('span').text(i);
