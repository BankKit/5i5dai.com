 ...
 * 
 * Describe: The basic business logic script file for the site message page (../../../../../../www/site.message.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.11.23 18:11 ( Tony ).
 * 
 * Last Update: 2014.11.23 19:17 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (global, document, require, console, undefined) {
	...
	fn= function (require) {
		...
		var SJ, easing, modernizr, tlns, extend, _mod, mute, evtName, srl;
		...
		_mod = (function () {
			...
			return {
				...
				init: function () {
					...
					SJ('.tableRowSet').children(".tableRow").on(evtName, function (e) {

						SJ('.contentModule').fadeIn({

							done: function () {

								SJ('.agreementShow > div').studioScroll();
					...
					var _fn = function (e) {
						...
						SJ('.contentModule').fadeOut();

					};

					SJ('.modalOverlay').on(evtName, _fn);

					SJ('.aBtn').on(evtName, _fn);

					SJ('.aClose').on(evtName, _fn);
