 ...
 * 
 * Describe: The basic business logic script file for the second master page (../../../../../../www/master@2.html).
 * 
		...
		_mod = (function (hawaii) {
			...
			tlns.init = function () {
				...
				if (!mute) {
					...
					console.info('Master page (../www/master@2.html) basic logic loaded.');
