 ...
 * 
 * Describe: The basic business logic script file for the email authentication page (../../../../../../www/email.authentication@2.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2013.12.19 16:00 ( Tony ).
 * 
 * Last Update: 2013.12.19 17:40 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
			...
			return {
				...
				init: function () {
					...
					function excute() {
						...
						var i = +SJ('.p_2').children('span').text();
					...
					SJ('.coreArea > a').on('click', function (e) {
