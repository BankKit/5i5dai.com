 ...
 * 
 * Describe: The business logic bootstrap script file for the withdrawal page (../../../../../../www/withdrawal.html).    ...//TODO: Check description.
 * 
 ...
 * Version: 0.1.0-alpha
 * 
 * Creation Date: 2014.02.25 10:17 ( Tony ).
 * 
 * Last Update: 2014.02.26 11:56 ( Tony ).    ...//TODO: Update the 'Last Update'.
 * 
...
(function (require, console) {
	...
	fn = function (require) {
		...
		basicLogic = require('logic/withdrawal.logic.min');
		
		// plusLogic = require('logic/withdrawal.logic.plus');
